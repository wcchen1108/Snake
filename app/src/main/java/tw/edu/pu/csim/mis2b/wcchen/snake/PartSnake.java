...
public class PartSnake {
    ...
    public Rect getrTop() {
        return new Rect(this.x, this.y-10*Constants.SCREEN_HEIGHT/1920, this.x+GameView.size0fMap, this.y);
    }
    ...
    public Rect getrBottom() {
        return new Rect(this.x, this.y+GameView.size0fMap, this.x+GameView.size0fMap, this.y+GameView.size0fMap+10*Constants.SCREEN_HEIGHT/1920);
    }
    ...
    public Rect getrLeft() {
        return new Rect(this.x-10*Constants.SCREEN_WIDTH/1080, this.y, this.x, this.y+GameView.size0fMap);
    }
    ...
    public Rect getrRight() {
        return new Rect(this.x+GameView.size0fMap, this.y, this.x+GameView.size0fMap+10*Constants.SCREEN_WIDTH/1080, this.y+GameView.size0fMap);
    }
